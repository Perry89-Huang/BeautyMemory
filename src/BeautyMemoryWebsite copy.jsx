        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button 
              ...
              className="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:shadow-lg transition-all"
            >
              開始分析
            </button>
          </div>
      ...
      <footer className="bg-slate-900 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-6 flex justify-center gap-6 text-sm text-slate-400">
            ...
            <a href="mailto:info@beautymemory.life" className="hover:text-purple-400 transition-colors">
              聯絡我們
            </a>
            <button 
              onClick={() => showNotification('隱私政策功能即將推出', 'info')}
              className="hover:text-purple-400 transition-colors"
            >
              隱私政策
            </button>
